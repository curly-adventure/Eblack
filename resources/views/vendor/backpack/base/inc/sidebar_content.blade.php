...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('category') }}'><i class='nav-icon la la-database'></i> Categories</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('souscategorie') }}'><i class='nav-icon la la-database'></i> Sous Categories</a></li>
...
<!--li class='nav-item'><a class='nav-link' href='{{ backpack_url('images') }}'>
<i class='nav-icon la la-database'></i> Images</a></li-->
<!--li class='nav-item'><a class='nav-link' href='{{ backpack_url('adresse') }}'>
