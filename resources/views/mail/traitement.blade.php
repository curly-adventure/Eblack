  ...
  <div style="background-color:#FFFFFF;">
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  ...
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:20px;word-break:break-word;">
                      <div style="font-family:Helvetica;font-size:16px;line-height:1;text-align:center;color:#FFFFFF;">Merci pour votre achat, <br/> votre commande est en cour de traitement et vous sera livré dans les plus bref délais</div>
                    </td>
                  </tr>
                </table>
              </div>
    ...
    <div style="background:#356cc7;background-color:#356cc7;margin:0px auto;max-width:600px;">
      ...
      <![endif]-->
                  ...
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;padding-top:28px;padding-right:25px;padding-left:25px;word-break:break-word;">
                      <div style="font-family:Helvetica;font-size:18px;line-height:1;text-align:center;color:#FFFFFF;">detail de la commande</div>
                    </td>
                  </tr>
                  <tr>
      ...
      <![endif]-->
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:10px;padding-right:25px;padding-left:25px;word-break:break-word;">
                      <div style="font-family:Helvetica;font-size:15px;line-height:1;text-align:left;color:#FFFFFF;">veillez noter que vos articles vous serons livré au plus grand tard dans 1 semaine</div>
                    </td>
                  </tr>
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:10px;padding-right:25px;padding-left:25px;word-break:break-word;">
